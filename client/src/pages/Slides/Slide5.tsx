  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto mt-12">
        ...
        <div className="mb-5">
          <ModernBadge color={modernColors.crypto} className="mb-3">
            MULTI-DOMAIN SOLUTION
          </ModernBadge>
          
          <p className={`${modernTypography.body} mt-3 mb-4 text-center font-medium text-sm`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            {processSteps.map((step, index) => (
              <div
                ...
                className="relative"
              >
                <ModernCard className="h-full p-4 flex flex-col items-center text-center" style={{
                  ...
                  <h3 className={`${modernTypography.subheading} mb-1 text-base`} style={{ 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col h-full">
            <ModernCard className="h-full p-5 flex-1 border-t-4" style={{
              ...
              <h3 className={`${modernTypography.subheading} mt-3 mb-3 text-base`} style={{ color: modernColors.military }}>
          ...
          <div className="flex flex-col h-full">
            <ModernCard className="h-full p-5 flex-1 border-t-4" style={{
              ...
              <h3 className={`${modernTypography.subheading} mt-3 mb-3 text-base`} style={{ color: modernColors.commercial }}>
